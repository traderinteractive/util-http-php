...
We welcome you to report [issues](https://github.com/dominionenterprises/util-http-php/issues) or submit
[pull requests](https://github.com/dominionenterprises/util-http-php/pulls).  While the below guidelines are necessary to get code merged, you can
...
## Travis CI
Our [Travis build](https://travis-ci.org/dominionenterprises/util-http-php) executes the build above against pull requests.
